...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="fixed top-4 right-4 z-50 w-12 h-12 rounded-full glass-effect hover:bg-primary/10 transition-all duration-300 hover:scale-110 group shadow-lg"
    >
